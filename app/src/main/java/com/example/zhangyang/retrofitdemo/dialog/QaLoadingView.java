...
public class QaLoadingView extends FrameLayout{
	...
	public QaLoadingView(Context context, int iconSizePx) {
	...
	public QaLoadingView(Context context, AttributeSet attrs){
	...
	private void initImageViews(int iconSizePx) {
		...
		int layoutSize = iconSizePx == -100 ? LayoutParams.WRAP_CONTENT : iconSizePx;
		LayoutParams fllp = new LayoutParams(layoutSize, layoutSize);
		...
		fllp = new LayoutParams(layoutSize, layoutSize);
		fllp.gravity = Gravity.CENTER;
